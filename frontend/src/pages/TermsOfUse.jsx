...
const Section = ({ title, children, darkMode }) => (
  <div style={{ marginBottom: 'clamp(24px, 4vw, 32px)' }}>
    <h2 style={{ fontSize: 'clamp(17px, 2.2vw, 20px)', fontWeight: 700, color: darkMode ? '#f1f5f9' : '#1a1a2e', marginBottom: 12, paddingBottom: 10, borderBottom: darkMode ? '2px solid #334155' : '2px solid #e8f0ff' }}>
      {title}
    </h2>
...
const TermsOfUse = () => {
  ...
  return (
    <div style={{ background: darkMode ? '#0f172a' : '#f8f9fa', minHeight: '100vh', padding: 'clamp(16px, 3vw, 24px) clamp(12px, 2vw, 24px)' }}>
      {/* Hero */}
      <div style={{
        maxWidth: 1200, margin: '0 auto clamp(16px, 3vw, 24px)',
        background: 'linear-gradient(135deg,#0f3460 0%,#16213e 60%,#1a1a2e 100%)',
        borderRadius: 16, padding: 'clamp(24px, 5vw, 40px) clamp(20px, 4vw, 32px)', color: '#fff', textAlign: 'center'
      }}>
        <div style={{ fontSize: 'clamp(11px, 1.3vw, 13px)', fontWeight: 600, color: '#a78bfa', textTransform: 'uppercase', letterSpacing: 2, marginBottom: 12 }}>
          Legal
        </div>
        <h1 style={{ fontSize: 'clamp(26px, 4vw, 34px)', fontWeight: 800, margin: '0 0 12px', color: '#fff' }}>Terms of Use</h1>
      ...
      <div style={{
        ...
        background: darkMode ? '#1e293b' : '#fff', borderRadius: 16,
        padding: 'clamp(20px, 4vw, 32px)',
        boxShadow: darkMode ? '0 2px 16px rgba(0,0,0,0.3)' : '0 2px 16px rgba(0,0,0,0.07)'
      }}>

        <p style={{ fontSize: 'clamp(14px, 1.5vw, 15px)', color: darkMode ? '#cbd5e1' : '#374151', lineHeight: 1.85, marginBottom: 16 }}>
        ...
        <Section title="1. About the Platform" darkMode={darkMode}>
        ...
        <Section title="2. Eligibility" darkMode={darkMode}>
        ...
        <Section title="3. Account Registration" darkMode={darkMode}>
          <ul style={{ paddingLeft: 24, listStyleType: 'disc' }}>
        ...
        <Section title="4. User Roles and Permissions" darkMode={darkMode}>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>The Platform operates with the following roles:</p>
          <ul style={{ paddingLeft: 24, listStyleType: 'disc' }}>
          ...
          <p style={{ marginTop: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>Role assignments are made at the discretion of TGS Tech Info administrators.</p>
        </Section>

        <Section title="5. Content Submission and Publishing" darkMode={darkMode}>
          <p style={{ fontWeight: 600, marginBottom: 6, fontSize: 'clamp(14px, 1.6vw, 15px)' }}>5.1 Contributor Responsibilities</p>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>By submitting content to TGS Tech Info, you represent and warrant that:</p>
          ...
          <p style={{ fontWeight: 600, marginBottom: 6, fontSize: 'clamp(14px, 1.6vw, 15px)' }}>5.2 Content Review Process</p>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>All submitted content undergoes an editorial review process. Administrators may:</p>
          <ul style={{ paddingLeft: 24, listStyleType: 'disc', marginBottom: 16 }}>
          ...
          <p style={{ fontWeight: 600, marginBottom: 6, marginTop: 16, fontSize: 'clamp(14px, 1.6vw, 15px)' }}>5.3 Licence Grant</p>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>By submitting content, you grant TGS Tech Info a <strong>non-exclusive, worldwide, royalty-free licence</strong> to host, display, distribute, promote, and archive the content on the Platform and associated channels (including newsletters and social media). You retain ownership of your content.</p>

          <p style={{ fontWeight: 600, marginBottom: 6, marginTop: 16, fontSize: 'clamp(14px, 1.6vw, 15px)' }}>5.4 Gated Content and Lead Generation</p>
          <p style={{ fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>Content publishers may configure gated content (requiring form submission for access) and external webhook integrations to receive lead data. Publishers are <strong>solely responsible</strong> for how they collect, use, and store lead data received via webhooks, and must comply with applicable data protection laws including GDPR and CCPA.</p>
        </Section>

        <Section title="6. Prohibited Conduct" darkMode={darkMode}>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>You agree <strong>not</strong> to:</p>
          <ul style={{ paddingLeft: 24, listStyleType: 'disc' }}>
        ...
        <Section title="7. Intellectual Property" darkMode={darkMode}>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>All Platform design, branding, logos, software code, and non-user-generated content are the <strong>exclusive property of TGS Tech Info</strong> and are protected by applicable intellectual property laws.</p>
          <p style={{ fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>You may not reproduce, distribute, modify, or create derivative works from Platform content without our prior written permission, except as expressly permitted (e.g., sharing published articles with proper attribution).</p>
        </Section>

        <Section title="8. Newsletter" darkMode={darkMode}>
          <ul style={{ paddingLeft: 24, listStyleType: 'disc' }}>
        ...
        <Section title="9. Third-Party Links and Integrations" darkMode={darkMode}>
        ...
        <Section title="10. Disclaimers" darkMode={darkMode}>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>The Platform and all content are provided on an <strong>"as is" and "as available"</strong> basis without warranties of any kind, express or implied, including but not limited to:</p>
          ...
          <p style={{ fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>Content published on TGS Tech Info represents the views of individual contributors and does <strong>not constitute professional advice</strong> (legal, financial, technical, or otherwise). Always seek qualified professional advice for your specific situation.</p>
        </Section>

        <Section title="11. Limitation of Liability" darkMode={darkMode}>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>To the fullest extent permitted by applicable law, TGS Tech Info and its officers, directors, employees, and affiliates shall <strong>not be liable</strong> for any:</p>
          <ul style={{ paddingLeft: 24, listStyleType: 'disc' }}>
          ...
          <p style={{ marginTop: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>Our <strong>total liability</strong> to you for any claim arising from use of the Platform shall not exceed the amount you paid us (if any) in the twelve months preceding the claim.</p>
        </Section>

        <Section title="12. Indemnification" darkMode={darkMode}>
          <p style={{ fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>You agree to <strong>indemnify, defend, and hold harmless</strong> TGS Tech Info and its affiliates from and against any claims, liabilities, damages, losses, and expenses (including reasonable legal fees) arising out of or related to: (a) your use of the Platform; (b) content you submit; (c) your violation of these Terms; or (d) your violation of any third-party rights.</p>
        </Section>

        <Section title="13. Account Termination" darkMode={darkMode}>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>We reserve the right to <strong>suspend or permanently terminate</strong> your account, with or without notice, if:</p>
          <ul style={{ paddingLeft: 24, listStyleType: 'disc' }}>
          ...
          <p style={{ marginTop: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>You may request account deletion at any time by contacting <a href="mailto:contact@tgstechinfo.com" style={{ color: '#6c5ce7' }}>contact@tgstechinfo.com</a>. Upon deletion, your published content may remain on the Platform unless you specifically request its removal.</p>
        </Section>

        <Section title="14. Governing Law and Dispute Resolution" darkMode={darkMode}>
          <p style={{ fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>These Terms are governed by and construed in accordance with the laws of the State of California, United States, without regard to its conflict of law provisions. Any disputes arising from these Terms or your use of the Platform shall be resolved through <strong>good-faith negotiation</strong>. If unresolved, disputes shall be submitted to <strong>binding arbitration</strong> in accordance with the rules of the American Arbitration Association, or to the courts of competent jurisdiction in California.</p>
        </Section>

        <Section title="15. Changes to These Terms" darkMode={darkMode}>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>We may update these Terms from time to time to reflect changes in our services, legal requirements, or business practices. We will notify registered users of <strong>material changes</strong> via email or in-platform notification.</p>
          <p style={{ fontSize: 'clamp(14px, 1.5vw, 15.5px)' }}>The "Last updated" date at the top of this page reflects the most recent revision. Continued use of the Platform after changes take effect constitutes your <strong>acceptance</strong> of the revised Terms.</p>
        </Section>

        <Section title="16. Contact Us" darkMode={darkMode}>
          <p style={{ marginBottom: 12, fontSize: 'clamp(14px, 1.5vw, 15.5px)', color: darkMode ? '#cbd5e1' : '#374151' }}>If you have any questions about these Terms of Use, please contact us:</p>
          <div style={{ marginTop: 16, padding: 'clamp(14px, 2.5vw, 20px) clamp(16px, 3vw, 24px)', background: darkMode ? 'rgba(108, 92, 231, 0.1)' : '#f5f0ff', borderRadius: 12, borderLeft: '4px solid #6c5ce7' }}>
            <p style={{ margin: '0 0 6px', fontWeight: 700, color: darkMode ? '#f1f5f9' : '#1a1a2e', fontSize: 'clamp(14px, 1.6vw, 15px)' }}>TGS Tech Info</p>
            <p style={{ margin: '0 0 4px', color: darkMode ? '#cbd5e1' : '#374151', fontSize: 'clamp(13px, 1.5vw, 14px)' }}>Email: <a href="mailto:contact@tgstechinfo.com" style={{ color: '#6c5ce7' }}>contact@tgstechinfo.com</a></p>
            <p style={{ margin: 0, color: darkMode ? '#cbd5e1' : '#374151', fontSize: 'clamp(13px, 1.5vw, 14px)' }}>Website: <a href="https://tgstechinfo.com" style={{ color: '#6c5ce7' }}>https://tgstechinfo.com</a></p>
          </div>
        </Section>
