...
export default function BuilderIntegration({
  ...
  contentId = null,
  triggerPreview = null,   // ref — parent assigns .current = openPreviewFn
  previewMeta = null,      // { title, short_description, banner_image, tags, seo_score, content_type, category }
}) {
